...
local function faceCardinalDirection(direction)
    if string.lower(direction) == "north" then
        while TDir == not 1 do
            if TDir == 4 then
                turtle.turnRight()
                break
    ...
    elseif string.lower(direction) == "east" then
        while TDir == not 2 do
            if TDir == 1 then
                turnRight()
                break
    ...
    elseif string.lower(direction) == "south" then
        while TDir == not 3 do
            if TDir == 2 then
                turnRight()
                break
    ...
    elseif string.lower(direction) == "west" then
        while TDir == not 4 do
            if TDir == 3 then
                turnRight()
                break
